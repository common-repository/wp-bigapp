...
class BigAppConf{
    ...
    //获取线上发布的最新版本的信息
    public static $mc_url_app_version_info = "http://192.168.180.50:8093/mc/mcapi/getLineVersion";
    public static $taskInfoUrl = 'http://192.168.180.93:8080/mc/mcapi/get_latest';	
    public static $appInfoUrl = 'http://192.168.180.93:8080/mc/mcapi/get_basic';
    public static $releaseApis = array(
		 'latest_package' => 'http://192.168.180.93:8080/product/ui/http/index.php?module=mc&controller=appversion&method=get_latest_package',
    );
